...
export class FileToolkit extends BaseToolkit {
  ...
  private async fileRead(params: any): Promise<ToolResult> {
  ...
  private async fileWrite(params: any): Promise<ToolResult> {
    const fullPath = join(this.workingDir, params.path);
    const encoding = params.encoding || 'utf-8';
  ...
  private async fileDelete(params: any): Promise<ToolResult> {
    const fullPath = join(this.workingDir, params.path);
  ...
  private async fileGlob(params: any): Promise<ToolResult> {
  ...
  private async fileExists(params: any): Promise<ToolResult> {
    const fullPath = join(this.workingDir, params.path);
  ...
  private async fileMkdir(params: any): Promise<ToolResult> {
    const fullPath = join(this.workingDir, params.path);
